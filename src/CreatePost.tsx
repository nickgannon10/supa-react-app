...
interface CreateNewPostResponse {
    data: any; // Define the expected structure of the data, if applicable.
    error: Error | null; // Define the error property as Error or null.
}
...
function createNewPost({
    ...
    return (supaClient.rpc as any)("create_new_post", {
        ...
        <>
            <form
                ...
                onSubmit={(event) => {
                    ...
                    createNewPost({ session, title, content })
                        .then(({ error }: CreateNewPostResponse) => {
                            // .then(({ error }: CreateNewPostResponse) => {
                            if (error) {
                                console.log(error);
                            } else {
